...
public class ExercicioOpcionalFatorial {
...
Agora crie uma nova classe, escreva um for que inicie uma variável n (número atual) como 1 e 
fatorial (resultado total) como 1. 
